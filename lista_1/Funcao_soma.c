/*
Soma 2 com função
Bem vindo ao primeiro exercício de função! Nos exercícios anteriores, toda a nossa lógica estava no escopo da função main.
Afinal, eram exercícios pequenos, né? Mas agora nossos códigos estão começando a ficar complexos e certas funcionalidades
podem ser reutilizáveis, seja no mesmo programa ou em diferentes programas.
Neste exercício, dado dois números inteiros que serão passados como argumentos, a sua função deve retornar a soma destes
dois números.
